...
function initActions() {
    ...
    function submitHandler(event) {
        event.stopPropagation();
        let validator = new Validate(board.board, boardSize)
        let isValid = validator.runTests();
        if (isValid) {
            alert("Parabéns meu amor, Te amo")
        } else {
            alert("Não se esqueça você é foda , Tente de novo")
        }
    }
    ...
    function dotMenuHandler(e) {
        ...
        if (isFirstTime_dotMenu) {
            ...
            // Recarregar a página em "Limpar Tudo"
            ...
            // Carregar novo jogo com as mesmas configurações do usuário
    ...
    // Começa aqui: depois que o usuário clica no botão "Iniciar Jogo"
